...
public:
	CLiquor(IBeveragePtr && beverage, LiquorType liquorType)
		: CCondimentDecorator(move(beverage)), m_liquorType(static_cast<unsigned>(liquorType))
	{}
protected:
	double GetCondimentCost()const override
	{
	...
	std::string GetCondimentDescription()const override
	{
		...
		case 1:
			return "Hazelnut liquor";
		default:
			return "Liquor";;
		}
	}
	unsigned m_liquorType = 0;
};
